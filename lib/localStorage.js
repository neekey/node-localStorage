...
(function () {
  ...
  var db;
  var LOCAL_DATA_PATH = PATH.resolve( __dirname, '../.localhost.json' );
  
  if( !FS.existsSync( LOCAL_DATA_PATH ) ){
    FS.writeSync( LOCAL_DATA_PATH, JSON.stringify({}));
  }
  ...
  function saveLocalData(){
    FS.writeSync( LOCAL_DATA_PATH, JSON.stringify( LOCAL_DATA ) );  
  } 
